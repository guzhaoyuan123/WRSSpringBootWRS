package com.niit.vhrend.controller.emp;

import com.niit.vhrend.model.*;
import com.niit.vhrend.service.*;
import com.niit.vhrend.utils.POIUtils;
...
public class EmpBasicController {
    ...
    public ResponseEntity<byte[]> exportData() {
        List<Employee> list =
                (List<Employee>) employeeService.getEmployeeByPage(null,
                        null, new Employee(),null).getData();
